...
class Seq2SeqModelStyleInput(nn.Module):
    """Container module with an encoder, deocder, embeddings."""

    def __init__(self, opt):
        """Initialize model."""
        super(Seq2SeqModelStyleInput, self).__init__()
        ...
        self.num_styles = len(opt.styles)
        self.style_embedding = nn.Embedding(self.num_styles, self.emb_dim)
    ...
    def init_embedding_weights(self):
        ...
        self.style_embedding.weight.data.uniform_(-init_range, init_range)
    ...
    def forward(self, src, src_lens, trg, src_oov, max_num_oov, src_mask, style_label):
        """
        ...
        :param style_label: an LongTensor, [batch]
        :return:
        """
        ...
        style_embedding = self.style_embedding(style_label)  # [batch_size, embed_size]
        ...
        for t in range(max_target_length):
            ...
            decoder_dist, h_t_next, _, attn_dist, p_gen, coverage = \
                self.decoder(y_t, h_t, memory_bank, src_mask, max_num_oov, src_oov, coverage, decoder_memory_bank, style_embedding)
