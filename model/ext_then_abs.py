...
class Seq2SeqModel(nn.Module):
    ...
    def forward(self, src, src_lens, trg, src_oov, max_num_oov, src_mask):
        """
        :param src: a list of Long tensor with size [num_sents, max_lens], oov words replaced by unk idx
        ...
        :param src_oov: a list of Long tensor with size [num_sents, max_lens], contains the index of oov words (used by copy)
